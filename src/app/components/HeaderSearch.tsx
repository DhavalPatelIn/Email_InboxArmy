    ...
    return (
        <form onSubmit={handleSearch} className="flex items-center gap-4 search-form">
            <div className="search-row flex items-center bg-theme-light-gray rounded-xl w-full 2xl:min-w-[520px] py-1 pr-2 relative">
                <input type="text" value={keyword} onChange={(e) => setKeyword(e.target.value)} placeholder="Search brands or keywords" className="bg-transparent w-full outline-none text-gray-700 placeholder-gray-500" />
